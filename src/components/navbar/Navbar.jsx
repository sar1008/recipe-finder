  ...
  return (
    <div className="align-center flex flex-row bg-sky-500 px-2">
      ...
      <div className="my-1 ml-auto flex gap-1">
        {currentUser !== null ? (
          <button
            className="rounded-md bg-indigo-600 p-2 py-1 text-sm text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            onClick={() => setCurrentUser(null)}
          >
            <Link to="/login">Logout (todo)</Link>
          </button>
        ) : (
          <>
